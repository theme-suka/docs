...
> 如果你使用了 [第三方服务 - 站点访问统计](https://theme-suka.github.io/docs/service/#Google) 启用了 Google Analytics，可以直接在 Google Webmaster 验证，无需再次使用 html 标记验证。
...
你也可以在文章的 `Front-Matter` 中覆盖这一设置，从而为你的部分文章设置独立的、不同的协议信息，详情可见 [开始创作 - Front Matter](https://theme-suka.github.io/docs/compose/#Front-Matter)
